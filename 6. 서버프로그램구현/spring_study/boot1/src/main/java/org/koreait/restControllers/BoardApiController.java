...
//        return ResponseEntity.status(HttpStatus.CREATED).body(boardForm);   // 응답코드를 201로 변환, 응답바디 존재
//        return ResponseEntity.status(HttpStatus.CREATED).build();   // 응답코드를 201로 변환, 응답바디 없음
//        return ResponseEntity.created(URI.create("/board/list")).build(); // 응답코드를 201로 변환, 응답바디 없음
        return ResponseEntity.noContent().build(); // 응답코드를 204로 변환
    }
