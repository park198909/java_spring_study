...
public class JPAExam03 {
    ...
    void ex01() {
        ...
        member = memberRepository.save(member); // 영속상태의 member 를 반환한다.
...
//        System.out.println(member);
        ...
        memberRepository.flush();           // DB 반영

        count = memberRepository.count();
        System.out.printf("전체 갯수 : %d%n",count);

//        memberRepository.flush();                       // member 를 데이터베이스에 적용
...
//        Pageable pageable = PageRequest.of(1,3);
    ...
    void ex04() {
        ...
        QMember member = QMember.member;    // 싱글톤 객체를 가져오기
